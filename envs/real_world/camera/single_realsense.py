...
from envs.real_world.common.timestamp_accumulator import get_accumulate_timestamp_idxs
from envs.real_world.shared_memory.shared_ndarray import SharedNDArray
from envs.real_world.shared_memory.shared_memory_ring_buffer import SharedMemoryRingBuffer
from envs.real_world.shared_memory.shared_memory_queue import SharedMemoryQueue, Full, Empty
...
class SingleRealsense(mp.Process):
    ...
    def __init__(
            ...
            video_recorder: Optional[VideoRecorder] = None,  # TODO not used
            verbose=False
        ):
        super().__init__()
        ...
        # if video_recorder is None:  # TODO
    ...
    def run(self):
        ...
        try:
            ...
            while not self.stop_event.is_set():
                ...
                # if self.verbose:
                #     print(f'[SingleRealsense {self.serial_number}] Vis time {time.time() - vis_start_time}')
                ...
                # if self.verbose:
                #     print(f'[SingleRealsense {self.serial_number}] Record time {time.time() - rec_start_time}')
                ...
                for i in range(n_cmd):
                    ...
                    if cmd == Command.SET_COLOR_OPTION.value:
                        ...
                        if start_time < 0:
                            start_time = None
                        # self.video_recorder.start(video_path, start_time=start_time) # TODO
                    elif cmd == Command.STOP_RECORDING.value:
                        # self.video_recorder.stop()  # TODO
