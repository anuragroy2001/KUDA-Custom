...
class KinHelper():
    def __init__(self, robot_name="trossen_vx300s_tactile_thin", headless=True):
        ...
        elif "xarm6" in robot_name:
            urdf_path = "robots/xarm6_no_gripper/xarm6.urdf"
            self.eef_name = 'link6'
    ...
    def compute_ik_sapien(self,initial_qpos,cartesian):
        ...
        elif 'xarm6' in self.robot_name:
            active_qmask= np.array([True,True,True,True,True,True])
